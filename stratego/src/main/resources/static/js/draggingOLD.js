...
board.th:src = "@{/resources/static/assets/map.svg}";
redButton.th:src = "@{/resources/static/assets/redbutton.svg}";
blueButton.th:src = "@{/resources/static/assets/bluebutton.svg}";
logo.th:src = "@{/resources/static/assets/logo.svg}";
